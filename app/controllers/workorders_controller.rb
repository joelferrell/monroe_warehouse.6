class WorkordersController < ApplicationController
  ...
  private
    ...
    def workorder_params
      params.require(:workorder).permit(:wo_number, :start_date, :comp_date, :est_completion, :requestor, :location, :repair_facility, :repair_type, :summary, :percent_complete, :item_id, :priority)
    end
end
